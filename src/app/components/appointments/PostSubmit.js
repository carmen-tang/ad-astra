...
export default function PostSubmit(props) {
  ...
  return (
    <section id="post-submit" className="float-right">
      ...
      {isOpen && (
        <div>
          <div id="modal-overlay" class="z-20 fixed top-0 left-0 w-full h-full bg-black-40" onClick={toggleModal}></div>

          <div id="modal" class="modal fixed max-w-full max-h-full z-30 flex flex-col rounded-lg bg-white closed shadow">
            <button class="text-white font-bold py-2 px-4 rounded z-10 absolute right-1 top-1" id="close-button" onClick={toggleModal}>
            ...
            <div class="absolute left-0 top-0 w-full h-full overflow-auto">
              <div class="pt-8 px-4">
                <h2 class="text-xl font-semibold">Modal Info</h2>
